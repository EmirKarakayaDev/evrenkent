    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-4">
        ...
        <div id="bekleyen-onaylar" class="card p-5 scroll-mt-24">
            ...
            @forelse ($pendingApprovals as $item)
                <a href="{{ $item['route'] }}" data-turbo="false" class="flex items-center justify-between gap-2 py-2.5 {{ ! $loop->last ? 'border-b border-slate-100' : '' }} hover:text-brand-700 transition-colors">
