...
@section('content')
    <div class="flex items-center justify-between mb-5">
        ...
        <a href="{{ route('panel.yayinlarim.taslaklarim.yeni') }}" class="inline-flex items-center gap-1.5 text-sm px-4 py-2 bg-slate-900 text-white rounded-md hover:bg-slate-800 transition-colors">
